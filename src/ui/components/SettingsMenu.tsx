...
import * as SubframeUtils from "@utils/SubFrameUtils";
...
const SettingsMenuRoot = React.forwardRef<HTMLElement, SettingsMenuRootProps>(
  function SettingsMenuRoot(
    ...
    return children ? (
      <div
        className={SubframeUtils.twClassNames(
          "group/786775dd flex h-full w-60 flex-col items-start gap-8  border-neutral-border bg-default-background px-6 py-6",
          className
        )}
        ref={ref as any}
        {...otherProps}
